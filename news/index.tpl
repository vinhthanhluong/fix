...
<head>
	...
	<title>{=$base_title=}｜高槻駅徒歩3分の歯医者｜河原歯科クリニック</title>
	...
	<div id="wrapper">
				...
				<div class="header-wrap">
					<h1 class="logo">
						<a href="https://www.kawahara-dc.net/">
							<img src="../images/logo.png" class="lo-pc" width="254" height="66" loading="lazy"
								alt="{=$base_title=}">
							<img src="../images/logo-sp.png" class="lo-sp" width="203" height="52" loading="lazy"
								alt="{=$base_title=}">
						</a>
					</h1>
					<ul class="header-btn">
		...
		<div class="btn-fix">
			<ul class="bf-list">
				<li>
					<p class="bf-ic">
						<img src="../images/ic-tell.png" loading="lazy" width="26" height="33" alt="tel">
					</p>
				...
				<li>
					<p class="bf-ic">
						<img src="../images/ic-lich.png" loading="lazy" width="39" height="38" alt="Web予約">
					</p>
		...
		<main id="main">
			<div id="mainvisual" class="vis-man">
				<div class="container">
					<h2 class="under_mv_ttl"><span class="wrap">{=$base_title=}</span></h2>
				</div>
			</div>
			<div id="content">
				<ul class="topic_path">
							...
							<ul class="blog_list_news">
								<ONContributeFetch>
									<li class="blog_list_news_item">
										...
										?>
										<p class="img">
											<ONIf condition="$img1_Value"> <img src="{=$img1_Src=}" alt="{=$title=}">
												<ONElse>
													<img src="../images/under_img01.jpg" alt="{=$title=}">
											</ONIf>
										</p>
										<div class="blog_list_news_ttl">
											<p class="cate cate{=$category_id=}">{=$category_name=}</p>
											<p class="date">{=$dates[0]=}.{=$dates[1]=}.{=$dates[2]=}</p>
										</div>
										<p class="ttl">{=mb_strimwidth($title, 0, 45, '…', 'UTF-8')=}</p>
										<a href="{=$url=}"></a>
									</li>
								</ONContributeFetch>
							</ul>
						...
						<div class="ft-cols">
							<div class="ft-item">
								<a href="https://www.kawahara-dc.net/" class="ft-logo">
									<img src="../images/logo-ft.png" width="348" height="89" loading="lazy"
										alt="河原歯科クリニック Kawahara Debtal Clinic">
								</a>
								<div class="d-flex">
									<div class="ft-call">
									...
									<a href="https://ssl.haisha-yoyaku.jp/m5593528/login/serviceAppoint/index?SITE_CODE=hp"
										...
										<img src="../images/ic-time.png" loading="lazy" width="28" height="26"
											alt="Web予約">
										Web予約
									</a>
								</div>
							...
							<div class="ft-item">
								<div class="ft-map">
									...
									<a href="https://goo.gl/maps/6Uq67QjsGnWV8rUMA" class="map-link f-serif"
										...
										Google mapで見る
										<img src="../images/ar-right.png" loading="lazy" width="6" height="11"
											alt="Google mapで見る">
									</a>
								</div>
						...
						<div class="d-flex">
							...
							<div class="fb-item">
								<a href="https://ssl.haisha-yoyaku.jp/m5593528/login/serviceAppoint/index?SITE_CODE=hp"
									...
									<img src="../images/fb-img02.jpg" loading="lazy" width="200" height="70"
										alt="EPARK">
								</a>
								<a href="https://www.shika-town.com/k00001318" class="fb-web" target="_blank"
									rel="noopener">
									<img src="../images/fb-img01.jpg" loading="lazy" width="200" height="70"
										alt="SHIKA-TOWN">
								</a>
							</div>
						</div>
