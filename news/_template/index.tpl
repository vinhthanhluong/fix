...
<head>
    ...
    <title>新着情報＆コラム一覧｜京都亀岡市・福知山市の外壁塗装「BANBA PAINT」</title>
    ...
    <div id="wrapper">
        ...
        <main id="main" class="main-under">
                ...
                <div class="container">
                    <div class="udr_fx_h2">
                        <div class="udr_box_h2">
                            <h2><span class="en">news</span>{=$base_title=}</h2>
                        </div>
                        <p class="img sp">
                            <img src="../images/udr_img_news01.jpg" alt="{=$base_title=}">
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div id="content">
                ...
                <div class="section">
                    <div class="under-bx">
                        <h3 class="h3">BANBA PAINTのインフォメーション一覧</h3>
                        <p>
                            京都・亀岡市、福知山市の外壁塗装会社「BANBA PAINT」の「NEWS & COLUMN」のご案内です。営業時間等のお知らせから、現地調査やスタッフミーティングの様子など、当社の活動状況をお伝えいたします。外壁塗装やリフォームに関するコラムも掲載しておりますので、ぜひお役立てください。
                        </p>
                    </div>
                </div>
                <div class="section">
                    <div class="news">
                        <div class="news-wrapper">
                            <ul class="news-catalog">
                                <ONCategory>
                                    <li>
                                        <a href="{=$category_url=}" class="news-cata">
                                ...
                                <div class="news-box">
                                    <ONContributeFetch>
                                        <div class="news-item">
                                            ...
                                            <p class="news-cate ncate{=$category_id=}">
                                                <span>{=$category_name=}</span>
                                            </p>
                                            <p class="news-tt">
                                                {=$title=}
                                            </p>
                                            <a href="{=$url=}" class="lk-full"></a>
                                        </div>
                                    </ONContributeFetch>
                                </div>
