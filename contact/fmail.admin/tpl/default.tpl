...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ja" lang="ja">
	<head>
		...
		<link rel="stylesheet" href="commons/smoothness/jquery-ui-1.10.1.custom.css" type="text/css" />
		...
		<script type="text/javascript" src="commons/jquery-ui-1.10.1.custom.js"></script>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				$('.setting_info').click(function() {
					...
					if($(this).html().indexOf('閉じる',0)>0){
							$(this).fadeOut("fast",function(){
								$(this).html('設定状況一覧を開く >>>').fadeIn("slow");
							});
					} else {
							$(this).fadeOut("fast", function(){
								$(this).html('<<< 設定状況一覧を閉じる').fadeIn("slow");
							});
					}
				}).next().hide();
			});
			...
			<div id="container">
				<div id="sidebar">
					<ul>
						...
						<!--module_list-->
						<li><a href="https://www.branding-t.co.jp/products/support/manuals/fmail5.000/" target="_blank" class="module">ご利用マニュアル<span>online manual</span></a></li>
					</ul>
				</div>
				<div id="contents">
