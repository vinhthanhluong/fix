<!--
	...
	function checkUserEdit(obj,msg){
		var errorMSG = "";
		if(obj.elements["conditional_name"].value == ""){
	...
	//追加
	function add_element_value_cc() {
		objId = 'cc';
		qtm_pos_subject(objId);
		var obj = document.getElementById(objId);
		qtm_posObj.end = qtm_posObj.start;
		qtm_posObj.subject = "<" + document.getElementById('add_elements_value_list_cc').value + ">";
		qtm_feedback_subject(obj);
	}
	//追加
	function add_element_value_bcc() {
		objId = 'bcc';
		qtm_pos_subject(objId);
		var obj = document.getElementById(objId);
		qtm_posObj.end = qtm_posObj.start;
		qtm_posObj.subject = "<" + document.getElementById('add_elements_value_list_bcc').value + ">";
		qtm_feedback_subject(obj);
	}
	//追加
