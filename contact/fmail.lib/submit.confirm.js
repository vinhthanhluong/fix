...
//画像ボタン利用時
document.write('<input type="button" id="submit_confirm" class="submit_confirm_button" value="送信内容確認" title="送信内容確認" onclick="fmail_sending(this.form)" onkeypress="fmail_sending(this.form)" />');
